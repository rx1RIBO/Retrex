...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Retrex Core retrex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  retrex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded retrex transaction") + "\n" +
                               "  retrex-tx [options] -create [commands]   " + _("Create hex-encoded retrex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded retrex transaction
