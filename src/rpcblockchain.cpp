...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    result.push_back(pair("mnLadderizedCollateral"));
...
/*
    UniValue zreexObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zreexObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zreexObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zREEXsupply", zreexObj));
*/
    return result;
}
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in retrex\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zREEXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zREEX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zREEX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zREEX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zREEX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zREEX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zREEX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zREEX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zREEX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zREEX denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of retrex addresses\n"
